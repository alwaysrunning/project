...
define(function(require, exports, module) {
    ...
    Menu.prototype = {
        ...
        opt: {
            ...
            menuDOM     : '<div class="wrap-menu" id="jMenu" data-animate="wrap-menu-animate">'
            +'<header class="ui-header"><a href="javascript: history.back(-1);" class="icon iconglobal ui-back">&#xe61c;</a><span class="ui-title">商品分类</span><a href="javascript:;" class="icon iconfont ui-handle" id="jCategory">&#xe60a;</a></header>'
